...
class PhysicsInformedNN:
    ...
    def __init__(self, layers_U, layers_V1,layers_V2,layers_V3, x_range, f, num_train_tps):
        ...
        # Physics
        self.f, self.e1,self.e2,self.e3, self.Uf, self.V1f,self.V2f,self.V3f,self.U_xf,self.V1_xf,self.V2_xf,self.V3_xf,self.V1e,self.V2e,self.V3e= self.pinn(self.xf)
        ...
        self.f_test,  self.e1_test, self.e2_test,self.e3_test,self.U_test, self.V1_test,self.V2_test,self.V3_test,self.U_x_test,self.V1_x_test,self.V2_x_test,self.V3_x_test,_,_,_= self.pinn(self.x_test_tf)
        # 均方误差
        ...
        # Fredholm积分微分方程
        # 均方误差
        self.loss_f = tf.reduce_mean((self.U_xf - (self.xf ** 2 - 1.0) * self.V1e + 0.5 * self.xf ** 2 * (
...
#####################初始化神经网络参数
    ...
    def pinn(self,x):
        ...
        return f,e1,e2,e3,U,V1,V2,V3, U_x ,V1_x,V2_x,V3_x,V1e,V2e,V3e
    ...
    def train(self, xx,  it, num_train_tps):
        ...
        loss_value_array = [loss_value_f*1,loss_value_e1*1,loss_value_e2*1,loss_value_e3*0.1,loss_value_i*1]
...
ElasImag(nIter =20000, print_period =2000, plot_period =2000)